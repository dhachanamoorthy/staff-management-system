<div class="container-fluid  dashboard-content">
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Late Entry</h2>
                <p class="pageheader-text"></p>
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php" class="breadcrumb-link">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Late Entry</a></li>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                 ...
                                 <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 mb-2">
                                        <button  class='btn btn-info' onclick='lateEntry()';>Track</button>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Late Entry
                    <div class="text-right">
                            <a class="btn btn-primary active" onclick="exportToExcel2()">Export</a>
                    </div>
                </div>         
